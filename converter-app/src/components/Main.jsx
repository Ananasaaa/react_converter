...
export function Main() {
  return (
    <section className="flex flex-col md:flex-row justify-center items-center text-white py-20 bg-cover bg-center"
    ...
    <div className="flex flex-col items-center md:items-start text-center md:text-left md:mr-10"> 
      ...
      <div className="mt-10 md:mt-0">
        <img src="/img/img_card.png" alt="Credit Card" className="mx-auto w-64" />
      </div>
    </section>
  );
}
