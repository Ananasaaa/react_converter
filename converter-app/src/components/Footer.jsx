      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
        <div className="flex flex-col items-center md:items-start">
          <div className="flex items-center mb-2">
            ...
            <Link to="/" className="font-bold text-lg">Чіп Чендж</Link>
          </div>
        ...
        <div className="flex flex-col items-center md:items-start space-y-2">
          <Link to="/services" className="hover:text-blue-600">Послуги</Link>
          <Link to="/converter" className="hover:text-blue-600">Конвертер валют</Link>
          <Link to="/contacts" className="hover:text-blue-600">Контакти</Link>
          <Link to="/faq" className="hover:text-blue-600">Задати питання</Link>
        </div>
        <div className="flex flex-col items-center md:items-start space-y-2">
